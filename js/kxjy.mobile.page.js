...
'editInfo':['${headerCancel}',
    ...
    '<div class="uba  b-gra c-wh us listBg">',
        '<div class="uc-t ub-f1 lis editinfoList infoList clearfix" _click="Device.prompt(\'请输入昵称\',function(txt){Page.setEditVal(\'nickname\',txt);},null,[\'确定\',\'取消\'],Tools.htmlDecode($(\'#nickname\').innerHTML))">',
