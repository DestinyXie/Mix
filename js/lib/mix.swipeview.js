...
define(['dom'], function(dom) {
    function SwipeView(el, options) {
        ...
        this.wrapper = typeof el == 'string' ? dom.$(el) : el;
        this.options = {
            text: null,
            numberOfPages: 3,
            snapThreshold: null,
        ...
        dom.addEvent(this.wrapper, Mix.event.START_EV, this);
        dom.addEvent(this.slider, Mix.event.TRNEND_EV, this);
        // in Opera >= 12 the transitionend event is lowercase so we register both events
        if (Mix.cssVender == 'O') {
            dom.addEvent(this.slider, Mix.event.TRNEND_EV.toLowerCase(), this);
        }
    };
    ...
    SwipeView.prototype = {
        ...
        destroy: function() {
            ...
            dom.removeEvent(this.wrapper, Mix.event.START_EV, this);
            dom.removeEvent(this.wrapper, Mix.event.MOVE_EV, this);
            dom.removeEvent(this.wrapper, Mix.event.END_EV, this);
            dom.removeEvent(this.wrapper, Mix.event.CANCEL_EV, this);
            dom.removeEvent(this.slider, Mix.event.TRNEND_EV, this);
        },
        ...
        handleEvent: function(e) {
            switch (e.type) {
                case Mix.event.START_EV:
                    this.__start(e);
                    break;
                case Mix.event.MOVE_EV:
                    this.__move(e);
                    break;
                case Mix.event.CANCEL_EV:
                case Mix.event.END_EV:
                    this.__end(e);
                    break;
                case 'resize':
                    this.__resize();
                    break;
                case Mix.event.TRNEND_EV:
                case 'otransitionend':
        ...
        __start: function(e) {
            ...
            dom.addEvent(this.wrapper, Mix.event.MOVE_EV, this);
            dom.addEvent(this.wrapper, Mix.event.END_EV, this);
            dom.addEvent(this.wrapper, Mix.event.CANCEL_EV, this);
